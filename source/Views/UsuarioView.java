...
public class UsuarioView {
    ...
    private static void inserir() {
        ...
        System.out.println("Usuário inserido com senha padrão usu@rio123");
    }
    ...
    private static Usuario lerComBaseEmTipo() {
        ...
        while (true) {
            System.out.print("Tipo de usuário (1 - Cliente, 2 - Corretor(a), 3 - Administrador(a): ");
            tipo = sc.nextInt();
